...
class Puisi extends StatefulWidget {
  @override
  _PuisiPageState createState() => _PuisiPageState();
}

class _PuisiPageState extends State<Puisi> {
  @override
  ...
  Future<List<DataModel>> ReadJsonData() async {
    final jsondata =
    await rootBundle.rootBundle.loadString('assets/puisi.json');
